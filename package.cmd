...
echo info: Build BaseN
msbuild.exe ".\src\BaseN.sln" /p:Configuration=Release /t:Rebuild
if ERRORLEVEL 1 (
    echo error: Failed to build BaseN
    goto EXIT
)

xcopy /y /r ".\src\BaseN\bin\Release\*.nupkg" ".\build"
